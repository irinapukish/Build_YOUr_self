...
const Article1 = () => {
    return (
        <div className="container">
            <div>
                <h1 className="title">Dlaczego regularne jedzenie jest ważne?</h1>
                <p className="content">
                ...
                <h1 className="title">Nieregularność = magazynowanie</h1>
                <p className="content">
                ...
                <h1 className="title">Jak długie powinny być przerwy między posiłkami?</h1>
                <img src="./images/zegar.jpg"></img>
                <p className="content">
                ...
                <h1 className="title">Dopasuj ilość posiłków do swoich potrzeb i możliwości</h1>
                ...
                <h1 className="title">Podsumowując</h1>
                <p className="content">
