...
const Register = () => {
  ...
  const [isUserDataProvided] = useState(localStorage.getItem("calories"));
        ...
        <>
          <div style={styles.container}>
            <h3 style={styles.title}>
              Wprowadź swoje dane fizyczne do kalkulatora kalorii
            </h3>
            <p style={styles.registerText}>
              Przejdż do wpisania danych{" "}
